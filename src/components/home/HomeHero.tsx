        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-accent-orange to-accent-orange/80 px-5 py-2.5 rounded-full text-sm font-bold mb-8 shadow-lg shadow-accent-orange/30">
              ...
              Профессиональное строительство в Грозном и ЧР
            </div>

            <h1 className="text-5xl lg:text-6xl xl:text-7xl font-extrabold mb-8 text-balance leading-tight">
              Строительные услуги{' '}
            ...
            <p className="text-xl lg:text-2xl text-neutral-100 mb-10 text-balance leading-relaxed">
          ...
          >
            <div className="relative">
              ...
              <div className="relative bg-white rounded-3xl shadow-2xl p-8 lg:p-10 backdrop-blur-sm">
                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-accent-orange/20 to-transparent rounded-3xl" />
                
                <h3 className="text-2xl lg:text-3xl font-extrabold text-primary mb-3 relative">
