...
export default function ServiceHero({
  ...
  return (
    <section className="relative bg-gradient-to-br from-primary via-primary-light to-primary-dark text-white overflow-hidden">
      ...
      <div className="container-custom py-12 sm:py-16 lg:py-20 xl:py-28">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center relative z-10">
          ...
          >
            ...
            {!priceFrom && (
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-accent-blue to-accent-blue/80 px-4 sm:px-5 py-2 sm:py-2.5 rounded-full text-xs sm:text-sm font-bold mb-4 sm:mb-6 lg:mb-8 shadow-lg shadow-accent-blue/30">
                <span className="w-2 h-2 bg-white rounded-full animate-pulse" />
                Цена по запросу
              </div>
            )}
            ...
            <p className="text-base sm:text-lg lg:text-xl text-neutral-200 mb-6 sm:mb-8 text-balance">
              {subtitle}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              ...
              >
                Получить расчёт <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 ml-2" />
              </a>
              <a
                href="/portfolio"
                className="btn-secondary-dark text-sm sm:text-base px-6 sm:px-8 py-3 sm:py-4 inline-flex items-center justify-center"
              >
                Смотреть портфолио
              </a>
            </div>
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl p-6 sm:p-8">
              ...
              <div className="space-y-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 sm:gap-3 w-full bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl px-6 py-3 sm:py-4 font-bold text-sm sm:text-base hover:shadow-xl hover:scale-105 transition-all duration-300 shadow-lg shadow-green-500/30"
                >
